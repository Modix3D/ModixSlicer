...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wipe_tower_width", "wipe_tower_cone_angle", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "mmu_segmented_region_max_width",
    "mmu_segmented_region_interlocking_depth", "wipe_tower_extruder", "wipe_tower_extra_flow", "wipe_tower_extra_spacing", "compatible_printers", "compatible_printers_condition", "inherits",
    "perimeter_generator", "wall_transition_length", "wall_transition_filter_deviation", "wall_transition_angle",
    "wall_distribution_count", "min_feature_size", "min_bead_width",


    // Modix config options
    "wipe_tower_depth",
    "wipe_tower_perimeters",
    "wipe_tower_density",
    "wipe_tower_brim_width",
    "wipe_tower_brim_layers",
    "wipe_tower_perimeter_speed",
    "wipe_tower_infill_speed"
