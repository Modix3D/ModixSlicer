///|/ Copyright (c) PR 2018 - 2023 Oleksandra Iushchenko @YuSanka, Lukáš Matěna @lukasmatena, David Kocík @kocikdav, Vojtěch Bubník @bubnikv, Tomáš Mészáros @tamasmeszaros, Enrico Turri @enricoturri1966, Filip Sykala @Jony01, Lukáš Hejl @hejllukas, Vojtěch Král @vojtechkral
///|/ Copyright (c) 2021 Jason Scurtu @xarbit
///|/ Copyright (c) 2019 John Drake @foxox
///|/
///|/ ported from lib/Slic3r/GUI/MainFrame.pm:
///|/ Copyright (c) PR 2016 - 2019 Vojtěch Bubník @bubnikv, Vojtěch Král @vojtechkral, Oleksandra Iushchenko @YuSanka, Tomáš Mészáros @tamasmeszaros, Enrico Turri @enricoturri1966
...
//        SLIC3R_VERSION + " - " +
//       _L("Remember to check for updates at https://modix3d.com"));
...
static wxMenu* generate_help_menu()
{
    ...
    append_menu_item(helpMenu, wxID_ANY, wxString::Format(_L("Modix &Website")),
        wxString::Format(_L("Open the Modix website in your browser")),
        [](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog("https://www.modix3d.com/"); });
