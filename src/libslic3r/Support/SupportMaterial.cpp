///|/ Copyright (c) PR 2016 - 2023 Vojtěch Bubník @bubnikv, Pavel Mikuš @Godrak, Lukáš Hejl @hejllukas, Roman Beránek @zavorka, Lukáš Matěna @lukasmatena, Vojtěch Král @vojtechkral
///|/ Copyright (c) SuperSlicer 2023 Remi Durand @supermerill
///|/ Copyright (c) 2016 Sakari Kapanen @Flannelhead
///|/
///|/ ported from lib/Slic3r/Print/SupportMaterial.pm:
///|/ Copyright (c) PR 2016 - 2017 Vojtěch Bubník @bubnikv
