...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig* config)
{
    ...
    for (auto el : { "wipe_tower_x", "wipe_tower_y", "wipe_tower_width", "wipe_tower_depth", "wipe_tower_perimeters", "wipe_tower_density", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_cone_angle", "wipe_tower_bridging", "wipe_tower_no_sparse_layers", "single_extruder_multi_material_priming" })
