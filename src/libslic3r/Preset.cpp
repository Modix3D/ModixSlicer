...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wipe_tower_width", "wipe_tower_length", "wipe_tower_cone_angle", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "wipe_tower_extra_perimeters", "single_extruder_multi_material_priming", "mmu_segmented_region_max_width",
