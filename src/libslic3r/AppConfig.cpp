///|/ Copyright (c) PR 2017 - 2023 Oleksandra Iushchenko @YuSanka, Vojtěch Bubník @bubnikv, Pavel Mikuš @Godrak, David Kocík @kocikdav, Lukáš Matěna @lukasmatena, Enrico Turri @enricoturri1966, Lukáš Hejl @hejllukas, Filip Sykala @Jony01, Vojtěch Král @vojtechkral
///|/
...
void AppConfig::set_defaults()
{
    if (m_mode == EAppMode::Editor) {
       ...
       if (get("notify_release").empty())
           set("notify_release", "none"); // or "none" or "release"
