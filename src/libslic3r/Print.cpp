...
void Print::_make_wipe_tower()
{
    ...
    if (m_wipe_tower_data.tool_ordering.back().wipe_tower_partitions > 0) {
        ...
        if (wipe_tower.layer_finished()) {
            ...
            wipe_tower.set_layer(float(m_wipe_tower_data.tool_ordering.back().print_z + layer_height), float(layer_height));
        } else {
        ...
        wipe_tower.set_layer(float(m_wipe_tower_data.tool_ordering.back().print_z), float(layer_height));
    }
