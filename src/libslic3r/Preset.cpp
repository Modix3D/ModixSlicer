///|/ Copyright (c) PR 2017 - 2023 Oleksandra Iushchenko @YuSanka, Lukáš Matěna @lukasmatena, Tomáš Mészáros @tamasmeszaros, Lukáš Hejl @hejllukas, Vojtěch Bubník @bubnikv, Pavel Mikuš @Godrak, David Kocík @kocikdav, Enrico Turri @enricoturri1966, Vojtěch Král @vojtechkral
...
static std::vector<std::string> s_Preset_print_options {
    ...
    "perimeter_speed", "small_perimeter_speed", "external_perimeter_speed", "infill_speed", "wipe_tower_infill_speed", "wipe_tower_perimeter_speed", "solid_infill_speed",
    ...
    "wipe_tower_width", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "mmu_segmented_region_max_width",
    ...
    "wipe_tower_perimeters", "wipe_tower_depth", "wipe_tower_density",
    "wipe_tower_perimeter_extrusion_width", "wipe_tower_infill_extrusion_width",
    "wipe_tower_brim_layers"
};

static std::vector<std::string> s_Preset_filament_options {
    "filament_colour", "filament_diameter", "filament_type", "filament_notes", "filament_max_volumetric_speed",
