...
public:
    ...
    int load_wipe_tower_preview(
        float pos_x, float pos_y, float width, float length, float height, float cone_angle, float rotation_angle, bool size_unknown, float brim_width, TriangleMesh* out_mesh = nullptr);
#else
    int load_wipe_tower_preview(
        float pos_x, float pos_y, float width, float length, float height, float cone_angle, float rotation_angle, bool size_unknown, float brim_width);
