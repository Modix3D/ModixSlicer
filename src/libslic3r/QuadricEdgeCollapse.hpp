///|/ Copyright (c) PR 2021 - 2022 Tomáš Mészáros @tamasmeszaros, Filip Sykala @Jony01
///|/
...
#ifndef MODIXSLICER_QUADRIC_EDGE_COLLAPSE_HPP
#define MODIXSLICER_QUADRIC_EDGE_COLLAPSE_HPP
...
#endif // MODIXSLICER_QUADRIC_EDGE_COLLAPSE_HPP
