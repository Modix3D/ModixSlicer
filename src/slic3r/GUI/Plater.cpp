...
Plater::priv::priv(Plater *q, MainFrame *main_frame)
    ...
    , config(Slic3r::DynamicPrintConfig::new_from_defaults_keys({
        ...
        "wipe_tower", "wipe_tower_x", "wipe_tower_y", "wipe_tower_width", "wipe_tower_length", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_extra_perimeters", "wipe_tower_cone_angle", "wipe_tower_extra_spacing", "wipe_tower_extruder",
