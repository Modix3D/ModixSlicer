///|/ Copyright (c) PR 2017 - 2023 Lukáš Matěna @lukasmatena, Vojtěch Bubník @bubnikv, Enrico Turri @enricoturri1966
...
void WipeTower::set_extruder(size_t idx, const PrintConfig& config, const PrintRegionConfig& default_region_config)
{
    ...
    m_filpar[idx].is_soluble = config.wipe_tower_extruder == 0 ? true : (idx != size_t(config.wipe_tower_extruder - 1));
