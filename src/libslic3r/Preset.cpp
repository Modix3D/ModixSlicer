...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wipe_tower_width", "wipe_tower_depth", "wipe_tower_perimeters", "wipe_tower_density", "wipe_tower_cone_angle", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "single_extruder_multi_material_priming", "mmu_segmented_region_max_width",
    "mmu_segmented_region_interlocking_depth", "wipe_tower_extruder", "wipe_tower_no_sparse_layers", "compatible_printers", "compatible_printers_condition", "inherits",
