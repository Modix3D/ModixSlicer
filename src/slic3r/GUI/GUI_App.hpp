...
public:
    ...
    std::string logo_name() const { return is_editor() ? "ModixSlicer" : "ModixSlicer-gcodeviewer"; }
    ...
    // URL download - ModixSlicer gets system call to open prusaslicer:// URL which should contain address of download
